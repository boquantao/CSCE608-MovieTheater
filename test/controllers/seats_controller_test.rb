...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { booked: @seat.booked, seat_number: @seat.seat_number, show_id: @seat.show_id } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { booked: @seat.booked, seat_number: @seat.seat_number, show_id: @seat.show_id } }
